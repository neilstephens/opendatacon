...
void MD3PointTableAccess::Build(const bool isoutstation, const bool newdigitalcommands, asio::io_service& IOS)
{
...
{
	uint16_t md3index = ShiftLeft8(moduleaddress) | channel;
...
{
	uint16_t Md3Index = ShiftLeft8(module) | channel;
