...
private:
	...
	std::unique_ptr<odc::strand_t, deleter> pTimerAccessStrand;
	...
	std::unique_ptr<odc::steady_timer, deleter> pCommsRideThroughTimer;
	std::unique_ptr<odc::steady_timer, deleter> pHeartBeatTimer;
	std::unique_ptr<odc::steady_timer, deleter> pStaleTimer;
