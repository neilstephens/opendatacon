...
void BinaryControl::CreateBinaryFeedback(std::size_t index,
	...
	std::size_t update_interval)
{
	...
	m_current_binary[index] = control_event;
}
...
void BinaryControl::CreateBinaryPosition(std::size_t index,
