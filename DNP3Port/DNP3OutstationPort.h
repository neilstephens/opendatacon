...
private:
	...
	template<typename T> void EventT(T& meas, uint16_t index, const std::string& SenderName);
	template<typename T, typename Q> void EventQ(Q& meas, uint16_t index, const std::string& SenderName);
