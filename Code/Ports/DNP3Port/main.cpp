...
extern "C" DNP3MasterPort* new_DNP3MasterPort(const std::string& Name, const std::string& File, const Json::Value& Overrides)
{
	return new DNP3MasterPort(Name,File,Overrides);
}

extern "C" DNP3OutstationPort* new_DNP3OutstationPort(const std::string& Name, const std::string& File, const Json::Value& Overrides)
{
