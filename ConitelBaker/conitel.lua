...
--f.mtos = ProtoField.bool ("conitel.mtos", "MasterCommand") 
--f.taggedcount = ProtoField.uint8 ("conitel.taggedcount",  "TaggedCount", base.HEX) 
...
function conitel_proto.dissector(buffer,pinfo,tree)
	...
	subtree:add(f.conitelfunction,conitelfunction) -- The buffer notation (highlinghting in data) only works for full bytes.
