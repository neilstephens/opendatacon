...
public:
	...
	void Event(ConnectState state, uint16_t index, const std::string& SenderName) final
	{
	...
	virtual void ConnectionEvent(ConnectState state, const std::string& SenderName) = 0;
