...
private:
	...
	template<typename T, typename Q> void EventQ(Q& meas, uint16_t index, const std::string& SenderName, std::shared_ptr<std::function<void (CommandStatus status)>> pStatusCallback);
