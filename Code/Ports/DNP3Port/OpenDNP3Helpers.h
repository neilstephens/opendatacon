...
opendnp3::StaticAnalogOutputStatusVariation StringToAnalogOutputStatusResponse(const std::string& str);
opendnp3::StaticBinaryOutputStatusVariation StringToBinaryOutputStatusResponse(const std::string& str);
